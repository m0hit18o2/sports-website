...
const NAV_LINKS = [
  { href: "/booking", label: "Multi Court" },
    ...
    <>
      ...
      <div className={`fixed top-0 left-0 h-full w-64 bg-white dark:bg-zinc-900 z-50 shadow-xl transform transition-transform duration-300 flex flex-col
        ...
        <div className="p-4 border-t border-zinc-100 dark:border-zinc-800">
          <button className="w-full flex items-center justify-center gap-3 py-2.5 px-4 border border-zinc-200 dark:border-zinc-700 rounded-lg text-sm text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors">
